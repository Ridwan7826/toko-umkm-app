...
<head>
    ...
    <title>{{ config('app.name', 'TokoKita') }} - Autentikasi</title>
    ...
    <div class="min-h-screen flex bg-white">
        ...
        <div class="w-full lg:w-[45%] flex flex-col justify-center px-8 sm:px-16 md:px-24 relative z-10 bg-white">
            ...
            <div class="absolute bottom-8 left-0 w-full text-center lg:text-left lg:px-24">
                <p class="text-xs text-slate-400 font-medium">&copy; {{ date('Y') }} TokoKita. Hak Cipta Dilindungi.</p>
            </div>
        </div>
        ...
        <div class="hidden lg:flex lg:w-[55%] relative items-center justify-center overflow-hidden bg-slate-900">
            ...
            <div class="absolute inset-0 z-0">
                <img src="{{ asset('images/ecommerce_login_bg.png') }}" alt="TokoKita Professional E-Commerce" class="w-full h-full object-cover opacity-60 mix-blend-overlay">
                <!-- Gradient Overlay -->
