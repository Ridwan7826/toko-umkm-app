...
<head>
    ...
    <title>{{ config('app.name', 'TokoKita') }} - Pusat Belanja UMKM</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex space-x-8 items-center font-medium">
                    ...
                    @auth
                        <a href="{{ url('/dashboard') }}" class="px-6 py-2.5 rounded-full bg-gradient-to-r from-emerald-500 to-blue-600 text-white font-semibold hover:shadow-lg hover:shadow-emerald-500/30 transition-all transform hover:-translate-y-0.5">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="text-slate-700 hover:text-emerald-600 font-semibold transition">Masuk</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="px-6 py-2.5 rounded-full bg-gradient-to-r from-emerald-500 to-blue-600 text-white font-semibold hover:shadow-lg hover:shadow-emerald-500/30 transition-all transform hover:-translate-y-0.5">
                                Daftar Sekarang
                            </a>
                        @endif
                    @endauth
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="px-8 py-4 rounded-full bg-gradient-to-r from-emerald-500 to-blue-600 text-white font-bold text-lg hover:shadow-xl hover:shadow-emerald-500/30 transition-all transform hover:-translate-y-1">
                                Masuk ke Dashboard
                            </a>
                        @else
                            <a href="{{ route('register') }}" class="px-8 py-4 rounded-full bg-gradient-to-r from-emerald-500 to-blue-600 text-white font-bold text-lg hover:shadow-xl hover:shadow-emerald-500/30 transition-all transform hover:-translate-y-1">
                                Mulai Berjualan
                            </a>
