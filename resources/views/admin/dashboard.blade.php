    ...
    <div class="py-8 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-between items-center bg-white p-4 rounded-lg shadow-sm border border-slate-200">
                ...
                <a href="{{ route('dashboard', ['refresh' => 1]) }}" class="inline-flex items-center px-4 py-2 bg-blue-900 text-white rounded hover:bg-blue-800 transition text-sm font-semibold shadow-md border-b-2 border-blue-950">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-gradient-to-br from-blue-900 to-blue-800 p-6 rounded-xl shadow-lg relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-3xl font-extrabold text-white">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</p>
                    </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200 relative overflow-hidden">
                    ...
                    <p class="text-3xl font-extrabold text-slate-800">{{ number_format($totalOrders, 0, ',', '.') }}</p>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200 relative overflow-hidden">
                    ...
                    <p class="text-3xl font-extrabold text-slate-800">{{ number_format($totalShops, 0, ',', '.') }}</p>
                    <div class="mt-4 flex items-center text-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200 relative overflow-hidden">
                    ...
                    <p class="text-3xl font-extrabold text-blue-600">Rp {{ number_format($aov, 0, ',', '.') }}</p>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200 relative overflow-hidden">
                    ...
                    <p class="text-3xl font-extrabold text-red-600">{{ number_format($cancelRate, 1, ',', '.') }}%</p>
