            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('public.categories.show', $product->category->id ?? 1)); ?>" class="hover:text-emerald-600 transition-colors"><?php echo e($product->category->name ?? 'Kategori'); ?></a>
                    </div>
                </li>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-0">
                ...
                <div class="lg:col-span-3 p-8 lg:p-12 flex flex-col">
                    ...
                    <div class="flex items-center gap-4 mb-8 pb-8 border-b border-slate-100">
                        ...
                        <a href="<?php echo e(route('public.shops.show', $product->shop->id)); ?>" class="flex items-center gap-2 group">
                    ...
                    <div class="mt-auto">
                        <form action="<?php echo e(route('buyer.cart.add')); ?>" method="POST" class="flex flex-col sm:flex-row gap-4">
                            <?php echo csrf_field(); ?>
