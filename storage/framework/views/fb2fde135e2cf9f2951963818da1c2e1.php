        ...
        <div>
            ...
            <div class="relative">
                ...
                <select id="role" name="role" class="block w-full pl-10 px-4 py-3 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-slate-50 focus:bg-white transition-colors" required>
                    <option value="pembeli" <?php echo e(old('role') == 'pembeli' ? 'selected' : ''); ?>>Pembeli - Saya ingin berbelanja</option>
                    <option value="penjual" <?php echo e(old('role') == 'penjual' ? 'selected' : ''); ?>>Penjual - Saya ingin buka toko</option>
                </select>
            </div>
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
        ...
        <p class="text-center text-sm text-slate-600 mt-6">
            Sudah punya akun? 
            <a href="<?php echo e(route('login')); ?>" class="font-bold text-emerald-600 hover:text-emerald-500 transition-colors">Masuk di sini</a>
        </p>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Toko_Kita\resources\views\auth\register.blade.php ENDPATH**/ ?>