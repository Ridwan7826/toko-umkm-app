...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-slate-800 leading-tight">
                <?php echo e(__('Ubah Produk: ')); ?> <?php echo e($product->name); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="<?php echo e(route('seller.products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="md:col-span-2">
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200 mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" value="<?php echo e(old('name', $product->name)); ?>" required class="w-full border-slate-300 rounded-lg shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                            </div>

                            <div class="mb-4">
                                <label for="description" class="block text-sm font-medium text-slate-700 mb-1">Deskripsi <span class="text-red-500">*</span></label>
                                <textarea name="description" id="description" rows="5" required class="w-full border-slate-300 rounded-lg shadow-sm focus:border-emerald-500 focus:ring-emerald-500"><?php echo e(old('description', $product->description)); ?></textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2 mt-2">
                                    <?php
                                        $currentCategories = old('category_ids', $product->categories->pluck('id')->toArray());
                                    ?>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="category_ids[]" value="<?php echo e($category->id); ?>" class="rounded border-slate-300 text-emerald-600 shadow-sm focus:border-emerald-300 focus:ring focus:ring-emerald-200 focus:ring-opacity-50" <?php echo e(is_array($currentCategories) && in_array($category->id, $currentCategories) ? 'checked' : ''); ?>>
                            ...
                            <div id="variants-container">
                                <?php
                                    ...
                                    if(empty($oldVariants)) {
                                        $oldVariants = [ [ 'name' => '', 'sku' => '', 'price' => '', 'weight' => '', 'stock' => '' ] ];
                                    }
                                ?>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200 sticky top-6">
                            ...
                            <?php if($product->image): ?>
                                <div class="mb-4">
                                    ...
                                    <img src="<?php echo e(Storage::url($product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full rounded-lg border border-slate-200 object-cover aspect-square">
                                </div>
                            <?php endif; ?>

                            <div class="mb-4">
                                <label for="image" class="block text-sm font-medium text-slate-700 mb-2">Ganti Foto (Opsional, Maks 2MB)</label>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Toko_Kita\resources\views\seller\products\edit.blade.php ENDPATH**/ ?>