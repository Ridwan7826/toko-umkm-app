        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                ...
                <a href="#" class="bg-white rounded-2xl p-6 flex flex-col items-center justify-center text-center border border-slate-100 hover:border-emerald-300 hover:shadow-lg hover:shadow-emerald-100 transition-all group">
                    ...
                    <h3 class="font-semibold text-slate-800"><?php echo e($category->name); ?></h3>
                    <p class="text-xs text-slate-400 mt-1"><?php echo e($category->products_count); ?> Produk</p>
                </a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl transition-all group">
                    <div class="aspect-square bg-slate-100 relative overflow-hidden">
                        <img src="<?php echo e($product->image ? asset('storage/'.$product->image) : 'https://placehold.co/400x400/e2e8f0/64748b?text=Produk'); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    ...
                    <div class="p-5">
                        <div class="flex items-center gap-2 mb-2">
                            <span class="text-xs font-medium px-2 py-1 bg-slate-100 text-slate-600 rounded-md"><?php echo e($product->categories->first()->name ?? 'Umum'); ?></span>
                        </div>
                        <h3 class="font-bold text-lg text-slate-900 mb-1 line-clamp-1">
                            <a href="<?php echo e(route('public.products.show', $product->id)); ?>" class="hover:text-emerald-600 transition"><?php echo e($product->name); ?></a>
                        </h3>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="font-extrabold text-emerald-600 text-lg">
                                Rp <?php echo e(number_format($product->price ?? ($product->variants->first()->price ?? 0), 0, ',', '.')); ?>

                            </div>
                            <a href="<?php echo e(route('public.products.show', $product->id)); ?>" class="w-10 h-10 rounded-full bg-slate-50 hover:bg-emerald-50 flex items-center justify-center text-slate-400 hover:text-emerald-600 transition-colors">
