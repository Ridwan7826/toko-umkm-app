    ...
    <div class="max-w-3xl">
        ...
        <form action="<?php echo e(route('admin.categories.update', $category->id)); ?>" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" value="<?php echo e($category->name); ?>" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 transition" required>
            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Toko_Kita\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>