        ...
        <div>
            <div class="flex items-center justify-between mb-2">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="text-sm font-bold text-emerald-600 hover:text-emerald-500 transition-colors" href="<?php echo e(route('password.request')); ?>">
                        Lupa sandi?
                    </a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
        ...
        <div class="flex items-center pt-2">
            <label for="remember_me" class="inline-flex items-center group cursor-pointer">
                ...
                <span class="ml-3 text-sm font-medium text-slate-600 group-hover:text-slate-900 transition-colors"><?php echo e(__('Ingat sesi saya')); ?></span>
            </label>
        </div>
        ...
        <?php if(Route::has('register')): ?>
            <p class="text-center text-sm font-medium text-slate-500 mt-8 pt-6 border-t border-slate-100">
                Belum memiliki akun? 
                <a href="<?php echo e(route('register')); ?>" class="font-bold text-emerald-600 hover:text-emerald-700 transition-colors">Daftar sebagai Penjual</a>
            </p>
        <?php endif; ?>
    </form>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Toko_Kita\resources\views/auth/login.blade.php ENDPATH**/ ?>